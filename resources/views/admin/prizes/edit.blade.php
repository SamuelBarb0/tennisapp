...
<div class="max-w-2xl">
    <div class="flex items-center gap-3 mb-6">
        ...
        <h2 class="text-xl font-bold">Editar Premio</h2>
    </div>

    <form action="{{ route('admin.prizes.update', $prize) }}" method="POST" enctype="multipart/form-data" class="bg-white rounded-2xl p-6 border border-gray-100 shadow-sm space-y-5">
        @csrf
        @method('PUT')
        <div>
