    ...
    <form action="{{ route('admin.tournaments.store') }}" method="POST" enctype="multipart/form-data" class="bg-white rounded-2xl p-6 border border-gray-100 shadow-sm space-y-5">
        ...
        <div class="grid grid-cols-2 gap-4">
            <div>
                ...
                @php
                    // Same tier list as edit.blade.php — sync stores full strings
                    // ("ATP Masters 1000", "WTA Grand Slam", etc.), so we keep them
                    // available as options on creation too for consistency.
                    $tournamentTypes = [
