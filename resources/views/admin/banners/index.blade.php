...
<div class="flex items-center justify-between mb-6">
    ...
    <a href="{{ route('admin.banners.create') }}" class="px-5 py-2.5 bg-tc-primary text-white rounded-xl text-sm font-medium hover:bg-tc-primary-hover transition-colors">
        + Nuevo banner
    </a>
</div>
