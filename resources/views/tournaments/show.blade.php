            ...
            <div class="min-w-0">
                ...
                <div class="mt-3.5 fade-up-2">
                    ...
                    <span class="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full text-[10px] font-bold"
                        ...
                        Cierra: {{ $lockDate?->bogota()->format('d M, h:i A') }}
                    </span>
                    @endif
                </div>
                @endauth
...
{{-- `flex-1` lets the gradient stretch to fill the remaining viewport height
     (set up by the layout's <main class="flex flex-col">). `flex flex-col`
     here lets child `flex-1` blocks (like "No hay partidos") stretch too. --}}
<div class="bg-gradient-to-b from-gray-50 to-gray-100/60 flex-1 flex flex-col">
    ...
    {{-- "No matches" empty state. Hidden when the paywall is active — otherwise
         ...
         Inside the outer flex wrapper so `flex-1` stretches it to fill space. --}}
