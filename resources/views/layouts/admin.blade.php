...
<head>
    ...
    <link rel="icon" type="image/png" href="{{ asset('images/image-removebg-preview.png') }}">
    <link rel="apple-touch-icon" href="{{ asset('images/image-removebg-preview.png') }}">
        ...
        <aside :class="sidebarOpen ? 'translate-x-0 w-64' : '-translate-x-full w-0 lg:w-20 lg:translate-x-0'"
            ...
            <nav class="flex-1 p-3 space-y-1 overflow-y-auto">
                ...
                $adminLinks = [
                    ...
                    ['route' => 'admin.payments.index', 'label' => 'Pagos', 'icon' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3-3H6a3 3 0 00-3 3v8a3 3 0 003 3z"/>'],
                    ...
                    ['route' => 'admin.pages.index', 'label' => 'Páginas', 'icon' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/>'],
