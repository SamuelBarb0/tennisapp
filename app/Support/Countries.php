...
/**
 * ISO 3166-1 alpha-2 country list with Spanish display names.
 * Used by the registration form's country dropdown and by anywhere we need
 * to render a country name from a 2-letter code.
 *
 * Sorted alphabetically (Spanish locale) at runtime.
 */
class Countries
{
    /** Code => Spanish name. */
    public const ALL = [
        ...
        'BI' => 'Burundi', 'BT' => 'Bután', 'CV' => 'Cabo Verde', 'KH' => 'Camboya',
        'CM' => 'Camerún', 'CA' => 'Canadá', 'QA' => 'Catar', 'TD' => 'Chad',
        'CL' => 'Chile', 'CN' => 'China', 'CY' => 'Chipre', 'VA' => 'Ciudad del Vaticano',
        'CO' => 'Colombia', 'KM' => 'Comoras', 'CG' => 'Congo', 'CD' => 'Congo (Rep. Dem.)',
        'KP' => 'Corea del Norte', 'KR' => 'Corea del Sur', 'CI' => 'Costa de Marfil', 'CR' => 'Costa Rica',
        'HR' => 'Croacia', 'CU' => 'Cuba', 'CW' => 'Curazao', 'DK' => 'Dinamarca',
        'DM' => 'Dominica', 'EC' => 'Ecuador', 'EG' => 'Egipto', 'SV' => 'El Salvador',
        'AE' => 'Emiratos Árabes Unidos', 'ER' => 'Eritrea', 'SK' => 'Eslovaquia', 'SI' => 'Eslovenia',
        'ES' => 'España', 'US' => 'Estados Unidos', 'EE' => 'Estonia', 'ET' => 'Etiopía',
        ...
        'GY' => 'Guyana', 'HT' => 'Haití', 'HN' => 'Honduras', 'HK' => 'Hong Kong',
        'HU' => 'Hungría', 'IN' => 'India', 'ID' => 'Indonesia', 'IQ' => 'Irak',
        'IR' => 'Irán', 'IE' => 'Irlanda', 'IM' => 'Isla de Man', 'IS' => 'Islandia',
        'KY' => 'Islas Caimán', 'CK' => 'Islas Cook', 'FO' => 'Islas Feroe', 'FK' => 'Islas Malvinas',
        'MP' => 'Islas Marianas del Norte', 'MH' => 'Islas Marshall', 'SB' => 'Islas Salomón', 'TC' => 'Islas Turcas y Caicos',
        'VG' => 'Islas Vírgenes Británicas', 'VI' => 'Islas Vírgenes de los EE. UU.', 'IL' => 'Israel', 'IT' => 'Italia',
        ...
        'NE' => 'Níger', 'NG' => 'Nigeria', 'NU' => 'Niue', 'NF' => 'Norfolk',
        'NO' => 'Noruega', 'NC' => 'Nueva Caledonia', 'NZ' => 'Nueva Zelanda', 'OM' => 'Omán',
        ...
        'GB' => 'Reino Unido', 'CF' => 'República Centroafricana', 'CZ' => 'República Checa', 'DO' => 'República Dominicana',
        'RE' => 'Reunión', 'RW' => 'Ruanda', 'RO' => 'Rumania', 'RU' => 'Rusia',
        'EH' => 'Sáhara Occidental', 'WS' => 'Samoa', 'AS' => 'Samoa Americana', 'BL' => 'San Bartolomé',
        'KN' => 'San Cristóbal y Nieves', 'SM' => 'San Marino', 'MF' => 'San Martín (parte francesa)', 'PM' => 'San Pedro y Miquelón',
        'VC' => 'San Vicente y las Granadinas', 'SH' => 'Santa Elena', 'LC' => 'Santa Lucía', 'ST' => 'Santo Tomé y Príncipe',
    ...
    /** Returns code => name pairs sorted by Spanish name. */
    public static function options(): array
    {
        $list = self::ALL;
        // Stable sort using strcoll with Spanish locale
        uasort($list, fn($a, $b) => strcoll($a, $b));
        return $list;
    }
